...
<head>
    ...
    <!-- Css Styles -->
    <link rel="stylesheet" href="loanday/css/bootstrap.min.css" type="text/css">
    <link rel="stylesheet" href="loanday/css/font-awesome.min.css" type="text/css">
    <link rel="stylesheet" href="loanday/css/elegant-icons.css" type="text/css">
    <link rel="stylesheet" href="loanday/css/nice-select.css" type="text/css">
    <link rel="stylesheet" href="loanday/css/magnific-popup.css" type="text/css">
    <link rel="stylesheet" href="loanday/css/jquery-ui.min.css" type="text/css">
    <link rel="stylesheet" href="loanday/css/owl.carousel.min.css" type="text/css">
    <link rel="stylesheet" href="loanday/css/slicknav.min.css" type="text/css">
    <link rel="stylesheet" href="loanday/css/style.css" type="text/css">
</head>
...
<body>
    ...
    <div class="offcanvas-menu-wrapper">
        ...
        <div class="offcanvas__logo">
            <a href="./index.html"><img src="loanday/img/logo.png" alt=""></a>
        </div>
        ...
        <ul class="offcanvas__widget">
            <li><i class="fa fa-map-marker"></i>Abuja</li>
            <li><i class="fa fa-phone"></i>+234 081-0109-1022</li>
            <li><i class="fa fa-envelope"></i> Info@myload.com</li>
        </ul>
        <div class="offcanvas__language">
            <img src="loanday/img/flag.png" alt="">
            <span>English</span>
    ...
    <!-- Hero Section Begin -->
    <section class="hero set-bg" data-setbg="loanday/img/hero-bg.jpg">
        <div class="container">
            <div class="row">
                <div class="col-lg-5">
            ...
            <div class="row">
                ...
                <div class="col-lg-5 offset-lg-1">
                    <div class="home__about__img">
                        <img src="loanday/img/about/home-about.jpg" alt="">
                    </div>
                </div>
            </div>
        </div>
    ...
    <!-- Contact Begin -->
    <div id="contact" class="contact-widget set-bg" data-setbg="loanday/img/contact-widget.jpg">
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-md-6">
                    <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6">
                        ...
                        <div class="footer__copyright__text">
                            <p>Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | <i class="fa fa-heart" aria-hidden="true"></i> by <a href="#" target="_blank">MyLoan</a></p>
                        </div>
                        <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                    </div>
                </div>
    ...
    <!-- Js Plugins -->
    <script src="loanday/js/jquery-3.3.1.min.js"></script>
    <script src="loanday/js/bootstrap.min.js"></script>
    <script src="loanday/js/jquery.nice-select.min.js"></script>
    <script src="loanday/js/jquery-ui.min.js"></script>
    <script src="loanday/js/jquery.nicescroll.min.js"></script>
    <script src="loanday/js/jquery.magnific-popup.min.js"></script>
    <script src="loanday/js/jquery.slicknav.js"></script>
    <script src="loanday/js/owl.carousel.min.js"></script>
    <script src="loanday/js/main.js"></script>
</body>
