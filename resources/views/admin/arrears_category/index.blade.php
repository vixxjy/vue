                    ...
                    <div class="row align-items-end">
                        <div class="col-lg-8">
                            <div class="page-header-title">
                                ...
                                <div class="d-inline">
                                    <h5>Registered Arrears Categories page</h5>
                                    <span>Registered Arrears Categories Table</span>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="page-header-breadcrumb">
                                <ul class=" breadcrumb breadcrumb-title">
                                    ...
                                    <li class="breadcrumb-item">
                                        <a href="#">Registered Arrears Categories</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                            ...
                            <div class="page-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="card">
                                        ...
                                        <form method="POST" class="form-horizontal" action="{{ route('arrears_category.store')}}" enctype="multipart/form-data">
                                        {{ csrf_field() }}              
                                            <div class="row">
                                                <div class="col-sm-2">   
                                                <div class="form-group">
                                                    <label for="exampleInputPassword1">Name of Arrears Category</label>
                                                </div>
                                                </div>
                                                <div class="col-sm-6">   
                                                <div class="form-group">
                                                    <input type="text" name="name" class="form-control" placeholder="Enter Arrears Category Name">
                                                </div>
                                                </div>
                                            </div>
                                            <button type="submit" class="btn btn-primary btn-sm">Add Arrears Category</button>
                                        ...
                                        <div class="card">
                                            <div class="card-header">
                                                <h5>Registered Arrears Categories</h5>
                                                ...
                                                @if(count($datas) > 0)
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td className="text-right">
                                                            ...
                                                            <a href="{{route('arrears_category.delete', $data->slug)}}">
...
<div class="modal fade" id="editModal{{ $modal->slug }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form method="post" action="{{ route('arrears_category.update', $modal->slug)}}">
